package com.example.kailunlew.quizapp;
...
public class QuestionLibrary {
    ...
    private String mQuestions [] = {
        "Which part of the plant holds it in the soil ?",
            ...
            "This part of the plant attracks bees, butterflies and hummingbirds.",
    ...
    private String mCorrectAnswers[] = {"Root", "Leaves", "Flower", "Stem"};
